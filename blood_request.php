...
// connectdb();/
include_once '../web/private/config.php';
include_once '../web/private/database.php';
...
<div class="col-lg-12">
    <button type="button" class="btn bg-gradient-orange text-white mr-3 my-3 shadow-sm" data-toggle="modal" data-target="#DonorModal"><i class="fa-regular fa-square-plus"></i> Add New</button>
        ...
        <div class="card-body">
            <div class="table-responsive col-sm-12">
                <table class="table table-hover table-bordered table-hover w-auto small" id="list">
                    <thead>
                        <tr class="table-indigo bg-gradient-orange text-white">
